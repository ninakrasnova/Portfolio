...
info = pd.DataFrame(data = [['Москва', 'Понедельник', 'Среда', 'Пятница'],['Санкт-Петербург','Понедельник', 'Среда', 'Пятница']], columns=['city', 'monday', 'wednesday', 'friday'])
info
...
moscow_general = df[df['city'] == 'Moscow']# для которых значение в столбце 'city' равно 'Moscow'
